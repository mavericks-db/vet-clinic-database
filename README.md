...
```
$ git clone git@github.com:mavericks-db/vet-clinic-database.git
```
...
Feel free to check the [issues page](https://github.com/mavericks-db/vet-clinic-database/issues).
